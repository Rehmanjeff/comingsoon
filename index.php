...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Timeahead - Futuristic</title>
        ...
        <div class="home-content">
            ...
            <div class="home-logo">
                <a href="index-particles.html">
                    <img src="images/timeahead.png" alt="Homepage">
                </a>
            </div>
            ...
            <ul class="home-social">
                <li>
                <a href="https://facebok.com/timeahead.co"><i class="fab fa-facebook-f" aria-hidden="true"></i><span>Facebook</span></a>
                </li>
                <li>
                <a href="https://x.com/rehmank360"><i class="fab fa-twitter" aria-hidden="true"></i><span>Twiiter</span></a>
                </li>
                <li>
                <a href="https://linkedin.com/company/timeahead/"><i class="fab fa-linkedin" aria-hidden="true"></i><span>LinkedIn</span></a>
                </li>
                <!--<li>-->
    ...
    <div class="s-info">
        ...
        <div class="row info-wrapper">
            ...
            <div class="col-seven tab-full info-main">
                <h1>We are Timeahead. We make awesome stuff.</h1>
                <p>
            ...
            <div class="col-four tab-full pull-right info-contact">
                ...
                <div class="info-block">
                    ...
                    <p>
                        <a href="mailto:#0" class="info-email">habib@timeahead.co</a><br>
                        <a href="tel:+601112344640" class="'info-phone">+601112344640</a>
                    </p>
                </div>
                ...
                <div class="info-block">
                    ...
                    <ul class="info-social">
                        <li>
                            <a href="https://facebook.com/timeahead.co"><i class="fab fa-facebook" aria-hidden="true"></i>
                            <span>Facebook</span></a>
                        </li>
                        <li>
                            <a href="https://x.com/rehmank360"><i class="fab fa-twitter" aria-hidden="true"></i>
                            <span>Twiiter</span></a>
                        </li>
                        <li>
                            <a href="https://linkedin.com/company/timeahead/"><i class="fab fa-linkedin" aria-hidden="true"></i>
